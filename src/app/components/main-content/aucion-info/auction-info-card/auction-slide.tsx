...
import carSlideImage from '@/assets/images/cars/car-slide.webp';
  ...
  const renderIconButtons = () =>
    ICONS.map(({ Component, label }) => (
      <Button
        ...
        size={'icon'}
        variant={'link'}
        className='h-12 w-12 rounded-full bg-[#6E6B6B] shadow-md'
      >
  ...
  return (
    ...
    >
      <section className='flex items-center justify-between '>
        ...
        <div className='m-2  flex items-center  gap-3 max-sm:flex-col md:m-5'>
          {renderIconButtons()}
        </div>
      </section>
    </figure>
