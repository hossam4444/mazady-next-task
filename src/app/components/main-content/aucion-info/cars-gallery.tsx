...
import carOne from '@/assets/images/cars/car1.jpg';
import carTwo from '@/assets/images/cars/car2.jpg';
import carThree from '@/assets/images/cars/car3.webp';
import carFour from '@/assets/images/cars/car4.webp';
import carFive from '@/assets/images/cars/car5.webp';
...
const CarImageGallery = () => {
  return (
    <aside className='flex  items-center justify-between gap-1 lg:flex-col lg:gap-2 '>
      <Button
        size={'icon'}
        className='h-8 w-8 rounded-lg bg-white shadow-md transition'
      >
